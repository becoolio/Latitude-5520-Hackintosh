 ...
 *
 * Disassembly of ssdt20.dat, Tue Nov 12 10:13:50 2024
 *
...
DefinitionBlock ("", "SSDT", 2, "PmRef", "Cpu0Cst", 0x00003001)
{
    ...
    Scope (\_SB.PR00)
    {
        ...
        Method (_CST, 0, Serialized)  // _CST: C-States
        {
            ...
            If ((\_SB.PR00.DGFF == One))
            {
                Local0 = \ECRB (0x5B)
                DISP ("\n _CST EC_ACPI_ADAPTIVE_C_STATE 0x5B = ")
                DISP (Local0)
                DISP ("\n")
                If ((PWRS == One))
                {
